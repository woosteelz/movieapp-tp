...
export default {
  ...
  methods: {
    ...
    getComments: function (movie) {
      axios({
        method: "get",
        url: `http://3.143.230.89/movies/${movie.movie_id}/comments/`,
    ...
    createComment: function (movie) {
      ...
      if (comment.content) {
        axios({
          method: "post",
          url: `http://3.143.230.89/movies/${movie.movie_id}/comment/`,
          data: comment,
          headers: this.setToken(),
        })
          .then((res) => {
    ...
    createReview: function (movie) {
      ...
      if (review.title) {
        axios({
          method: "post",
          url: `http://3.143.230.89/movies/${movie.movie_id}/reviews/`,
          data: review,
          headers: this.setToken(),
        })
          .then((res) => {
    ...
    async getReviewlist(movie) {
      await axios
        .get(`http://3.143.230.89/movies/${movie.movie_id}/reviews/`)
        .then(
          (res) => {
    ...
    like: function (review) {
      axios({
        method: "post",
        url: `http://3.143.230.89/movies/like/${review.id}/`,
        headers: this.setToken(),
      })
        .then((res) => {
          console.log(res);
    ...
    deleteComment: function (movie, comment) {
      axios({
        method: "delete",
        url: `http://3.143.230.89/movies/${this.movie.movie_id}/${comment.id}/comment/`,
        headers: this.setToken(),
      })
        .then((res) => {
          console.log(res);
  ...
  created() {
    ...
    axios({
      method: "get",
      url: `http://3.143.230.89/movies/${this.$route.query.pk}/`,
      headers: this.setToken(),
    })
      .then((res) => {
        console.log(res);
